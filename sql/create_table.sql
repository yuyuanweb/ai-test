...
INSERT INTO `model` (`id`, `name`, `description`, `provider`, `contextLength`, `inputPrice`, `outputPrice`, `recommended`, `isChina`, `supportsMultimodal`, `supportsImageGen`, `supportsToolCalling`, `tags`, `rawData`, `createTime`, `updateTime`, `isDelete`, `totalTokens`, `totalCost`) VALUES ('deepseek/deepseek-chat', 'DeepSeek: DeepSeek V3', 'DeepSeek-V3 is the latest model from the DeepSeek team, building upon the instruction following and coding abilities of the previous versions. Pre-trained on nearly 15 trillion tokens, the reported evaluations reveal that the model outperforms other open-source models and rivals leading closed-source models.\n\nFor model details, please visit [the DeepSeek-V3 repo](https://github.com/deepseek-ai/DeepSeek-V3) for more information, or see the [launch announcement](https://api-docs.deepseek.com/news/news1226).', 'DeepSeek', 163840, 0.300000, 1.200000, 1, 1, 0, 0, 1, '[\"文本生成\"]', '{\"id\":\"deepseek/deepseek-chat\",\"name\":\"DeepSeek: DeepSeek V3\",\"created\":1735241320,\"description\":\"DeepSeek-V3 is the latest model from the DeepSeek team, building upon the instruction following and coding abilities of the previous versions. Pre-trained on nearly 15 trillion tokens, the reported evaluations reveal that the model outperforms other open-source models and rivals leading closed-source models.\\n\\nFor model details, please visit [the DeepSeek-V3 repo](https://github.com/deepseek-ai/DeepSeek-V3) for more information, or see the [launch announcement](https://api-docs.deepseek.com/news/news1226).\",\"contextLength\":163840,\"pricing\":{\"prompt\":\"0.0000003\",\"completion\":\"0.0000012\"},\"architecture\":{\"inputModalities\":[\"text\"],\"outputModalities\":[\"text\"]}}', '2026-01-28 01:01:58', '2026-02-01 02:00:03', 0, 0, 0.000000);
INSERT INTO `model` (`id`, `name`, `description`, `provider`, `contextLength`, `inputPrice`, `outputPrice`, `recommended`, `isChina`, `supportsMultimodal`, `supportsImageGen`, `supportsToolCalling`, `tags`, `rawData`, `createTime`, `updateTime`, `isDelete`, `totalTokens`, `totalCost`) VALUES ('deepseek/deepseek-chat-v3-0324', 'DeepSeek: DeepSeek V3 0324', 'DeepSeek V3, a 685B-parameter, mixture-of-experts model, is the latest iteration of the flagship chat model family from the DeepSeek team.\n\nIt succeeds the [DeepSeek V3](/deepseek/deepseek-chat-v3) model and performs really well on a variety of tasks.', 'DeepSeek', 163840, 0.190000, 0.870000, 0, 1, 0, 0, 1, '[\"文本生成\"]', '{\"id\":\"deepseek/deepseek-chat-v3-0324\",\"name\":\"DeepSeek: DeepSeek V3 0324\",\"created\":1742824755,\"description\":\"DeepSeek V3, a 685B-parameter, mixture-of-experts model, is the latest iteration of the flagship chat model family from the DeepSeek team.\\n\\nIt succeeds the [DeepSeek V3](/deepseek/deepseek-chat-v3) model and performs really well on a variety of tasks.\",\"contextLength\":163840,\"pricing\":{\"prompt\":\"0.00000019\",\"completion\":\"0.00000087\"},\"architecture\":{\"inputModalities\":[\"text\"],\"outputModalities\":[\"text\"]}}', '2026-01-28 01:01:58', '2026-02-01 02:00:03', 0, 3657, 0.000806);
INSERT INTO `model` (`id`, `name`, `description`, `provider`, `contextLength`, `inputPrice`, `outputPrice`, `recommended`, `isChina`, `supportsMultimodal`, `supportsImageGen`, `supportsToolCalling`, `tags`, `rawData`, `createTime`, `updateTime`, `isDelete`, `totalTokens`, `totalCost`) VALUES ('deepseek/deepseek-chat-v3.1', 'DeepSeek: DeepSeek V3.1', 'DeepSeek-V3.1 is a large hybrid reasoning model (671B parameters, 37B active) that supports both thinking and non-thinking modes via prompt templates. It extends the DeepSeek-V3 base with a two-phase long-context training process, reaching up to 128K tokens, and uses FP8 microscaling for efficient inference. Users can control the reasoning behaviour with the `reasoning` `enabled` boolean. [Learn more in our docs](https://openrouter.ai/docs/use-cases/reasoning-tokens#enable-reasoning-with-default-config)\n\nThe model improves tool use, code generation, and reasoning efficiency, achieving performance comparable to DeepSeek-R1 on difficult benchmarks while responding more quickly. It supports structured tool calling, code agents, and search agents, making it suitable for research, coding, and agentic workflows. \n\nIt succeeds the [DeepSeek V3-0324](/deepseek/deepseek-chat-v3-0324) model and performs well on a variety of tasks.', 'DeepSeek', 32768, 0.150000, 0.750000, 0, 1, 0, 0, 1, '[\"文本生成\"]', '{\"id\":\"deepseek/deepseek-chat-v3.1\",\"name\":\"DeepSeek: DeepSeek V3.1\",\"created\":1755779628,\"description\":\"DeepSeek-V3.1 is a large hybrid reasoning model (671B parameters, 37B active) that supports both thinking and non-thinking modes via prompt templates. It extends the DeepSeek-V3 base with a two-phase long-context training process, reaching up to 128K tokens, and uses FP8 microscaling for efficient inference. Users can control the reasoning behaviour with the `reasoning` `enabled` boolean. [Learn more in our docs](https://openrouter.ai/docs/use-cases/reasoning-tokens#enable-reasoning-with-default-config)\\n\\nThe model improves tool use, code generation, and reasoning efficiency, achieving performance comparable to DeepSeek-R1 on difficult benchmarks while responding more quickly. It supports structured tool calling, code agents, and search agents, making it suitable for research, coding, and agentic workflows. \\n\\nIt succeeds the [DeepSeek V3-0324](/deepseek/deepseek-chat-v3-0324) model and performs well on a variety of tasks.\",\"contextLength\":32768,\"pricing\":{\"prompt\":\"0.00000015\",\"completion\":\"0.00000075\"},\"architecture\":{\"inputModalities\":[\"text\"],\"outputModalities\":[\"text\"]}}', '2026-01-28 01:01:57', '2026-02-01 02:00:02', 0, 0, 0.000000);
INSERT INTO `model` (`id`, `name`, `description`, `provider`, `contextLength`, `inputPrice`, `outputPrice`, `recommended`, `isChina`, `supportsMultimodal`, `supportsImageGen`, `supportsToolCalling`, `tags`, `rawData`, `createTime`, `updateTime`, `isDelete`, `totalTokens`, `totalCost`) VALUES ('deepseek/deepseek-r1', 'DeepSeek: R1', 'DeepSeek R1 is here: Performance on par with [OpenAI o1](/openai/o1), but open-sourced and with fully open reasoning tokens. It\'s 671B parameters in size, with 37B active in an inference pass.\n\nFully open-source model & [technical report](https://api-docs.deepseek.com/news/news250120).\n\nMIT licensed: Distill & commercialize freely!', 'DeepSeek', 64000, 0.700000, 2.500000, 1, 1, 0, 0, 1, '[\"文本生成\"]', '{\"id\":\"deepseek/deepseek-r1\",\"name\":\"DeepSeek: R1\",\"created\":1737381095,\"description\":\"DeepSeek R1 is here: Performance on par with [OpenAI o1](/openai/o1), but open-sourced and with fully open reasoning tokens. It\'s 671B parameters in size, with 37B active in an inference pass.\\n\\nFully open-source model & [technical report](https://api-docs.deepseek.com/news/news250120).\\n\\nMIT licensed: Distill & commercialize freely!\",\"contextLength\":64000,\"pricing\":{\"prompt\":\"0.0000007\",\"completion\":\"0.0000025\"},\"architecture\":{\"inputModalities\":[\"text\"],\"outputModalities\":[\"text\"]}}', '2026-01-28 01:01:58', '2026-02-01 02:00:03', 0, 189, 0.000462);
INSERT INTO `model` (`id`, `name`, `description`, `provider`, `contextLength`, `inputPrice`, `outputPrice`, `recommended`, `isChina`, `supportsMultimodal`, `supportsImageGen`, `supportsToolCalling`, `tags`, `rawData`, `createTime`, `updateTime`, `isDelete`, `totalTokens`, `totalCost`) VALUES ('qwen/qwen-max', 'Qwen: Qwen-Max ', 'Qwen-Max, based on Qwen2.5, provides the best inference performance among [Qwen models](/qwen), especially for complex multi-step tasks. It\'s a large-scale MoE model that has been pretrained on over 20 trillion tokens and further post-trained with curated Supervised Fine-Tuning (SFT) and Reinforcement Learning from Human Feedback (RLHF) methodologies. The parameter count is unknown.', 'Alibaba', 32768, 1.600000, 6.400000, 1, 1, 0, 0, 1, '[\"中文\",\"文本生成\"]', '{\"id\":\"qwen/qwen-max\",\"name\":\"Qwen: Qwen-Max \",\"created\":1738402289,\"description\":\"Qwen-Max, based on Qwen2.5, provides the best inference performance among [Qwen models](/qwen), especially for complex multi-step tasks. It\'s a large-scale MoE model that has been pretrained on over 20 trillion tokens and further post-trained with curated Supervised Fine-Tuning (SFT) and Reinforcement Learning from Human Feedback (RLHF) methodologies. The parameter count is unknown.\",\"contextLength\":32768,\"pricing\":{\"prompt\":\"0.0000016\",\"completion\":\"0.0000064\"},\"architecture\":{\"inputModalities\":[\"text\"],\"outputModalities\":[\"text\"]}}', '2026-01-28 01:01:58', '2026-02-01 02:00:03', 0, 0, 0.000000);
INSERT INTO `model` (`id`, `name`, `description`, `provider`, `contextLength`, `inputPrice`, `outputPrice`, `recommended`, `isChina`, `supportsMultimodal`, `supportsImageGen`, `supportsToolCalling`, `tags`, `rawData`, `createTime`, `updateTime`, `isDelete`, `totalTokens`, `totalCost`) VALUES ('qwen/qwen-plus', 'Qwen: Qwen-Plus', 'Qwen-Plus, based on the Qwen2.5 foundation model, is a 131K context model with a balanced performance, speed, and cost combination.', 'Alibaba', 131072, 0.400000, 1.200000, 1, 1, 0, 0, 1, '[\"中文\",\"文本生成\"]', '{\"id\":\"qwen/qwen-plus\",\"name\":\"Qwen: Qwen-Plus\",\"created\":1738409840,\"description\":\"Qwen-Plus, based on the Qwen2.5 foundation model, is a 131K context model with a balanced performance, speed, and cost combination.\",\"contextLength\":131072,\"pricing\":{\"prompt\":\"0.0000004\",\"completion\":\"0.0000012\"},\"architecture\":{\"inputModalities\":[\"text\"],\"outputModalities\":[\"text\"]}}', '2026-01-28 01:01:58', '2026-02-01 02:00:03', 0, 23000, 0.010959);
INSERT INTO `model` (`id`, `name`, `description`, `provider`, `contextLength`, `inputPrice`, `outputPrice`, `recommended`, `isChina`, `supportsMultimodal`, `supportsImageGen`, `supportsToolCalling`, `tags`, `rawData`, `createTime`, `updateTime`, `isDelete`, `totalTokens`, `totalCost`) VALUES ('qwen/qwen-plus-2025-07-28', 'Qwen: Qwen Plus 0728', 'Qwen Plus 0728, based on the Qwen3 foundation model, is a 1 million context hybrid reasoning model with a balanced performance, speed, and cost combination.', 'Alibaba', 1000000, 0.400000, 1.200000, 0, 1, 0, 0, 1, '[\"中文\",\"文本生成\"]', '{\"id\":\"qwen/qwen-plus-2025-07-28\",\"name\":\"Qwen: Qwen Plus 0728\",\"created\":1757347599,\"description\":\"Qwen Plus 0728, based on the Qwen3 foundation model, is a 1 million context hybrid reasoning model with a balanced performance, speed, and cost combination.\",\"contextLength\":1000000,\"pricing\":{\"prompt\":\"0.0000004\",\"completion\":\"0.0000012\"},\"architecture\":{\"inputModalities\":[\"text\"],\"outputModalities\":[\"text\"]}}', '2026-01-28 01:01:57', '2026-02-01 02:00:02', 0, 0, 0.000000);
INSERT INTO `model` (`id`, `name`, `description`, `provider`, `contextLength`, `inputPrice`, `outputPrice`, `recommended`, `isChina`, `supportsMultimodal`, `supportsImageGen`, `supportsToolCalling`, `tags`, `rawData`, `createTime`, `updateTime`, `isDelete`, `totalTokens`, `totalCost`) VALUES ('qwen/qwen-plus-2025-07-28:thinking', 'Qwen: Qwen Plus 0728 (thinking)', 'Qwen Plus 0728, based on the Qwen3 foundation model, is a 1 million context hybrid reasoning model with a balanced performance, speed, and cost combination.', 'Alibaba', 1000000, 0.400000, 4.000000, 0, 1, 0, 0, 1, '[\"中文\",\"文本生成\"]', '{\"id\":\"qwen/qwen-plus-2025-07-28:thinking\",\"name\":\"Qwen: Qwen Plus 0728 (thinking)\",\"created\":1757347599,\"description\":\"Qwen Plus 0728, based on the Qwen3 foundation model, is a 1 million context hybrid reasoning model with a balanced performance, speed, and cost combination.\",\"contextLength\":1000000,\"pricing\":{\"prompt\":\"0.0000004\",\"completion\":\"0.000004\"},\"architecture\":{\"inputModalities\":[\"text\"],\"outputModalities\":[\"text\"]}}', '2026-01-28 01:01:57', '2026-02-01 02:00:02', 0, 0, 0.000000);
INSERT INTO `model` (`id`, `name`, `description`, `provider`, `contextLength`, `inputPrice`, `outputPrice`, `recommended`, `isChina`, `supportsMultimodal`, `supportsImageGen`, `supportsToolCalling`, `tags`, `rawData`, `createTime`, `updateTime`, `isDelete`, `totalTokens`, `totalCost`) VALUES ('qwen/qwen-turbo', 'Qwen: Qwen-Turbo', 'Qwen-Turbo, based on Qwen2.5, is a 1M context model that provides fast speed and low cost, suitable for simple tasks.', 'Alibaba', 1000000, 0.050000, 0.200000, 0, 1, 0, 0, 1, '[\"中文\",\"文本生成\"]', '{\"id\":\"qwen/qwen-turbo\",\"name\":\"Qwen: Qwen-Turbo\",\"created\":1738410974,\"description\":\"Qwen-Turbo, based on Qwen2.5, is a 1M context model that provides fast speed and low cost, suitable for simple tasks.\",\"contextLength\":1000000,\"pricing\":{\"prompt\":\"0.00000005\",\"completion\":\"0.0000002\"},\"architecture\":{\"inputModalities\":[\"text\"],\"outputModalities\":[\"text\"]}}', '2026-01-28 01:01:58', '2026-02-01 02:00:03', 0, 0, 0.000000);
INSERT INTO `model` (`id`, `name`, `description`, `provider`, `contextLength`, `inputPrice`, `outputPrice`, `recommended`, `isChina`, `supportsMultimodal`, `supportsImageGen`, `supportsToolCalling`, `tags`, `rawData`, `createTime`, `updateTime`, `isDelete`, `totalTokens`, `totalCost`) VALUES ('z-ai/glm-4.5', 'Z.AI: GLM 4.5', 'GLM-4.5 is our latest flagship foundation model, purpose-built for agent-based applications. It leverages a Mixture-of-Experts (MoE) architecture and supports a context length of up to 128k tokens. GLM-4.5 delivers significantly enhanced capabilities in reasoning, code generation, and agent alignment. It supports a hybrid inference mode with two options, a \"thinking mode\" designed for complex reasoning and tool use, and a \"non-thinking mode\" optimized for instant responses. Users can control the reasoning behaviour with the `reasoning` `enabled` boolean. [Learn more in our docs](https://openrouter.ai/docs/use-cases/reasoning-tokens#enable-reasoning-with-default-config)', 'Zhipu AI', 131072, 0.350000, 1.550000, 1, 1, 0, 0, 1, '[\"中文\",\"文本生成\"]', '{\"id\":\"z-ai/glm-4.5\",\"name\":\"Z.AI: GLM 4.5\",\"created\":1753471347,\"description\":\"GLM-4.5 is our latest flagship foundation model, purpose-built for agent-based applications. It leverages a Mixture-of-Experts (MoE) architecture and supports a context length of up to 128k tokens. GLM-4.5 delivers significantly enhanced capabilities in reasoning, code generation, and agent alignment. It supports a hybrid inference mode with two options, a \\\"thinking mode\\\" designed for complex reasoning and tool use, and a \\\"non-thinking mode\\\" optimized for instant responses. Users can control the reasoning behaviour with the `reasoning` `enabled` boolean. [Learn more in our docs](https://openrouter.ai/docs/use-cases/reasoning-tokens#enable-reasoning-with-default-config)\",\"contextLength\":131072,\"pricing\":{\"prompt\":\"0.00000035\",\"completion\":\"0.00000155\"},\"architecture\":{\"inputModalities\":[\"text\"],\"outputModalities\":[\"text\"]}}', '2026-01-28 01:01:57', '2026-02-01 02:00:02', 0, 0, 0.000000);
INSERT INTO `model` (`id`, `name`, `description`, `provider`, `contextLength`, `inputPrice`, `outputPrice`, `recommended`, `isChina`, `supportsMultimodal`, `supportsImageGen`, `supportsToolCalling`, `tags`, `rawData`, `createTime`, `updateTime`, `isDelete`, `totalTokens`, `totalCost`) VALUES ('z-ai/glm-4.5-air', 'Z.AI: GLM 4.5 Air', 'GLM-4.5-Air is the lightweight variant of our latest flagship model family, also purpose-built for agent-centric applications. Like GLM-4.5, it adopts the Mixture-of-Experts (MoE) architecture but with a more compact parameter size. GLM-4.5-Air also supports hybrid inference modes, offering a \"thinking mode\" for advanced reasoning and tool use, and a \"non-thinking mode\" for real-time interaction. Users can control the reasoning behaviour with the `reasoning` `enabled` boolean. [Learn more in our docs](https://openrouter.ai/docs/use-cases/reasoning-tokens#enable-reasoning-with-default-config)', 'Zhipu AI', 131072, 0.050000, 0.220000, 0, 1, 0, 0, 1, '[\"中文\",\"文本生成\"]', '{\"id\":\"z-ai/glm-4.5-air\",\"name\":\"Z.AI: GLM 4.5 Air\",\"created\":1753471258,\"description\":\"GLM-4.5-Air is the lightweight variant of our latest flagship model family, also purpose-built for agent-centric applications. Like GLM-4.5, it adopts the Mixture-of-Experts (MoE) architecture but with a more compact parameter size. GLM-4.5-Air also supports hybrid inference modes, offering a \\\"thinking mode\\\" for advanced reasoning and tool use, and a \\\"non-thinking mode\\\" for real-time interaction. Users can control the reasoning behaviour with the `reasoning` `enabled` boolean. [Learn more in our docs](https://openrouter.ai/docs/use-cases/reasoning-tokens#enable-reasoning-with-default-config)\",\"contextLength\":131072,\"pricing\":{\"prompt\":\"0.00000005\",\"completion\":\"0.00000022\"},\"architecture\":{\"inputModalities\":[\"text\"],\"outputModalities\":[\"text\"]}}', '2026-01-28 01:01:57', '2026-02-01 02:00:02', 0, 0, 0.000000);
INSERT INTO `model` (`id`, `name`, `description`, `provider`, `contextLength`, `inputPrice`, `outputPrice`, `recommended`, `isChina`, `supportsMultimodal`, `supportsImageGen`, `supportsToolCalling`, `tags`, `rawData`, `createTime`, `updateTime`, `isDelete`, `totalTokens`, `totalCost`) VALUES ('z-ai/glm-4.5-air:free', 'Z.AI: GLM 4.5 Air (free)', 'GLM-4.5-Air is the lightweight variant of our latest flagship model family, also purpose-built for agent-centric applications. Like GLM-4.5, it adopts the Mixture-of-Experts (MoE) architecture but with a more compact parameter size. GLM-4.5-Air also supports hybrid inference modes, offering a \"thinking mode\" for advanced reasoning and tool use, and a \"non-thinking mode\" for real-time interaction. Users can control the reasoning behaviour with the `reasoning` `enabled` boolean. [Learn more in our docs](https://openrouter.ai/docs/use-cases/reasoning-tokens#enable-reasoning-with-default-config)', 'Zhipu AI', 131072, 0.000000, 0.000000, 0, 1, 0, 0, 1, '[\"中文\",\"文本生成\"]', '{\"id\":\"z-ai/glm-4.5-air:free\",\"name\":\"Z.AI: GLM 4.5 Air (free)\",\"created\":1753471258,\"description\":\"GLM-4.5-Air is the lightweight variant of our latest flagship model family, also purpose-built for agent-centric applications. Like GLM-4.5, it adopts the Mixture-of-Experts (MoE) architecture but with a more compact parameter size. GLM-4.5-Air also supports hybrid inference modes, offering a \\\"thinking mode\\\" for advanced reasoning and tool use, and a \\\"non-thinking mode\\\" for real-time interaction. Users can control the reasoning behaviour with the `reasoning` `enabled` boolean. [Learn more in our docs](https://openrouter.ai/docs/use-cases/reasoning-tokens#enable-reasoning-with-default-config)\",\"contextLength\":131072,\"pricing\":{\"prompt\":\"0\",\"completion\":\"0\"},\"architecture\":{\"inputModalities\":[\"text\"],\"outputModalities\":[\"text\"]}}', '2026-01-28 01:01:57', '2026-02-01 02:00:02', 0, 39262, 0.000000);
INSERT INTO `model` (`id`, `name`, `description`, `provider`, `contextLength`, `inputPrice`, `outputPrice`, `recommended`, `isChina`, `supportsMultimodal`, `supportsImageGen`, `supportsToolCalling`, `tags`, `rawData`, `createTime`, `updateTime`, `isDelete`, `totalTokens`, `totalCost`) VALUES ('z-ai/glm-4.5v', 'Z.AI: GLM 4.5V', 'GLM-4.5V is a vision-language foundation model for multimodal agent applications. Built on a Mixture-of-Experts (MoE) architecture with 106B parameters and 12B activated parameters, it achieves state-of-the-art results in video understanding, image Q&A, OCR, and document parsing, with strong gains in front-end web coding, grounding, and spatial reasoning. It offers a hybrid inference mode: a \"thinking mode\" for deep reasoning and a \"non-thinking mode\" for fast responses. Reasoning behavior can be toggled via the `reasoning` `enabled` boolean. [Learn more in our docs](https://openrouter.ai/docs/use-cases/reasoning-tokens#enable-reasoning-with-default-config)', 'Zhipu AI', 65536, 0.600000, 1.800000, 0, 1, 1, 0, 1, '[\"多模态\",\"中文\",\"文本生成\"]', '{\"id\":\"z-ai/glm-4.5v\",\"name\":\"Z.AI: GLM 4.5V\",\"created\":1754922288,\"description\":\"GLM-4.5V is a vision-language foundation model for multimodal agent applications. Built on a Mixture-of-Experts (MoE) architecture with 106B parameters and 12B activated parameters, it achieves state-of-the-art results in video understanding, image Q&A, OCR, and document parsing, with strong gains in front-end web coding, grounding, and spatial reasoning. It offers a hybrid inference mode: a \\\"thinking mode\\\" for deep reasoning and a \\\"non-thinking mode\\\" for fast responses. Reasoning behavior can be toggled via the `reasoning` `enabled` boolean. [Learn more in our docs](https://openrouter.ai/docs/use-cases/reasoning-tokens#enable-reasoning-with-default-config)\",\"contextLength\":65536,\"pricing\":{\"prompt\":\"0.0000006\",\"completion\":\"0.0000018\"},\"architecture\":{\"inputModalities\":[\"text\",\"image\"],\"outputModalities\":[\"text\"]}}', '2026-01-28 01:01:57', '2026-02-01 02:00:02', 0, 0, 0.000000);
INSERT INTO `model` (`id`, `name`, `description`, `provider`, `contextLength`, `inputPrice`, `outputPrice`, `recommended`, `isChina`, `supportsMultimodal`, `supportsImageGen`, `supportsToolCalling`, `tags`, `rawData`, `createTime`, `updateTime`, `isDelete`, `totalTokens`, `totalCost`) VALUES ('z-ai/glm-4.6', 'Z.AI: GLM 4.6', 'Compared with GLM-4.5, this generation brings several key improvements:\n\nLonger context window: The context window has been expanded from 128K to 200K tokens, enabling the model to handle more complex agentic tasks.\nSuperior coding performance: The model achieves higher scores on code benchmarks and demonstrates better real-world performance in applications such as Claude Code、Cline、Roo Code and Kilo Code, including improvements in generating visually polished front-end pages.\nAdvanced reasoning: GLM-4.6 shows a clear improvement in reasoning performance and supports tool use during inference, leading to stronger overall capability.\nMore capable agents: GLM-4.6 exhibits stronger performance in tool using and search-based agents, and integrates more effectively within agent frameworks.\nRefined writing: Better aligns with human preferences in style and readability, and performs more naturally in role-playing scenarios.', 'Zhipu AI', 202752, 0.350000, 1.500000, 1, 1, 0, 0, 1, '[\"中文\",\"文本生成\"]', '{\"id\":\"z-ai/glm-4.6\",\"name\":\"Z.AI: GLM 4.6\",\"created\":1759235576,\"description\":\"Compared with GLM-4.5, this generation brings several key improvements:\\n\\nLonger context window: The context window has been expanded from 128K to 200K tokens, enabling the model to handle more complex agentic tasks.\\nSuperior coding performance: The model achieves higher scores on code benchmarks and demonstrates better real-world performance in applications such as Claude Code、Cline、Roo Code and Kilo Code, including improvements in generating visually polished front-end pages.\\nAdvanced reasoning: GLM-4.6 shows a clear improvement in reasoning performance and supports tool use during inference, leading to stronger overall capability.\\nMore capable agents: GLM-4.6 exhibits stronger performance in tool using and search-based agents, and integrates more effectively within agent frameworks.\\nRefined writing: Better aligns with human preferences in style and readability, and performs more naturally in role-playing scenarios.\",\"contextLength\":202752,\"pricing\":{\"prompt\":\"0.00000035\",\"completion\":\"0.0000015\"},\"architecture\":{\"inputModalities\":[\"text\"],\"outputModalities\":[\"text\"]}}', '2026-01-28 01:01:57', '2026-02-01 02:00:02', 0, 0, 0.000000);
INSERT INTO `model` (`id`, `name`, `description`, `provider`, `contextLength`, `inputPrice`, `outputPrice`, `recommended`, `isChina`, `supportsMultimodal`, `supportsImageGen`, `supportsToolCalling`, `tags`, `rawData`, `createTime`, `updateTime`, `isDelete`, `totalTokens`, `totalCost`) VALUES ('z-ai/glm-4.6:exacto', 'Z.AI: GLM 4.6 (exacto)', 'Compared with GLM-4.5, this generation brings several key improvements:\n\nLonger context window: The context window has been expanded from 128K to 200K tokens, enabling the model to handle more complex agentic tasks.\nSuperior coding performance: The model achieves higher scores on code benchmarks and demonstrates better real-world performance in applications such as Claude Code、Cline、Roo Code and Kilo Code, including improvements in generating visually polished front-end pages.\nAdvanced reasoning: GLM-4.6 shows a clear improvement in reasoning performance and supports tool use during inference, leading to stronger overall capability.\nMore capable agents: GLM-4.6 exhibits stronger performance in tool using and search-based agents, and integrates more effectively within agent frameworks.\nRefined writing: Better aligns with human preferences in style and readability, and performs more naturally in role-playing scenarios.', 'Zhipu AI', 204800, 0.440000, 1.760000, 0, 1, 0, 0, 1, '[\"中文\",\"文本生成\"]', '{\"id\":\"z-ai/glm-4.6:exacto\",\"name\":\"Z.AI: GLM 4.6 (exacto)\",\"created\":1759235576,\"description\":\"Compared with GLM-4.5, this generation brings several key improvements:\\n\\nLonger context window: The context window has been expanded from 128K to 200K tokens, enabling the model to handle more complex agentic tasks.\\nSuperior coding performance: The model achieves higher scores on code benchmarks and demonstrates better real-world performance in applications such as Claude Code、Cline、Roo Code and Kilo Code, including improvements in generating visually polished front-end pages.\\nAdvanced reasoning: GLM-4.6 shows a clear improvement in reasoning performance and supports tool use during inference, leading to stronger overall capability.\\nMore capable agents: GLM-4.6 exhibits stronger performance in tool using and search-based agents, and integrates more effectively within agent frameworks.\\nRefined writing: Better aligns with human preferences in style and readability, and performs more naturally in role-playing scenarios.\",\"contextLength\":204800,\"pricing\":{\"prompt\":\"0.00000044\",\"completion\":\"0.00000176\"},\"architecture\":{\"inputModalities\":[\"text\"],\"outputModalities\":[\"text\"]}}', '2026-01-28 01:01:57', '2026-02-01 02:00:02', 0, 0, 0.000000);
INSERT INTO `model` (`id`, `name`, `description`, `provider`, `contextLength`, `inputPrice`, `outputPrice`, `recommended`, `isChina`, `supportsMultimodal`, `supportsImageGen`, `supportsToolCalling`, `tags`, `rawData`, `createTime`, `updateTime`, `isDelete`, `totalTokens`, `totalCost`) VALUES ('z-ai/glm-4.6v', 'Z.AI: GLM 4.6V', 'GLM-4.6V is a large multimodal model designed for high-fidelity visual understanding and long-context reasoning across images, documents, and mixed media. It supports up to 128K tokens, processes complex page layouts and charts directly as visual inputs, and integrates native multimodal function calling to connect perception with downstream tool execution. The model also enables interleaved image-text generation and UI reconstruction workflows, including screenshot-to-HTML synthesis and iterative visual editing.', 'Zhipu AI', 131072, 0.300000, 0.900000, 0, 1, 1, 0, 1, '[\"多模态\",\"中文\",\"文本生成\"]', '{\"id\":\"z-ai/glm-4.6v\",\"name\":\"Z.AI: GLM 4.6V\",\"created\":1765207462,\"description\":\"GLM-4.6V is a large multimodal model designed for high-fidelity visual understanding and long-context reasoning across images, documents, and mixed media. It supports up to 128K tokens, processes complex page layouts and charts directly as visual inputs, and integrates native multimodal function calling to connect perception with downstream tool execution. The model also enables interleaved image-text generation and UI reconstruction workflows, including screenshot-to-HTML synthesis and iterative visual editing.\",\"contextLength\":131072,\"pricing\":{\"prompt\":\"0.0000003\",\"completion\":\"0.0000009\"},\"architecture\":{\"inputModalities\":[\"image\",\"text\",\"video\"],\"outputModalities\":[\"text\"]}}', '2026-01-28 01:01:57', '2026-02-01 02:00:02', 0, 0, 0.000000);
INSERT INTO `model` (`id`, `name`, `description`, `provider`, `contextLength`, `inputPrice`, `outputPrice`, `recommended`, `isChina`, `supportsMultimodal`, `supportsImageGen`, `supportsToolCalling`, `tags`, `rawData`, `createTime`, `updateTime`, `isDelete`, `totalTokens`, `totalCost`) VALUES ('z-ai/glm-4.7', 'Z.AI: GLM 4.7', 'GLM-4.7 is Z.AI’s latest flagship model, featuring upgrades in two key areas: enhanced programming capabilities and more stable multi-step reasoning/execution. It demonstrates significant improvements in executing complex agent tasks while delivering more natural conversational experiences and superior front-end aesthetics.', 'Zhipu AI', 202752, 0.400000, 1.500000, 0, 1, 0, 0, 1, '[\"中文\",\"文本生成\"]', '{\"id\":\"z-ai/glm-4.7\",\"name\":\"Z.AI: GLM 4.7\",\"created\":1766378014,\"description\":\"GLM-4.7 is Z.AI’s latest flagship model, featuring upgrades in two key areas: enhanced programming capabilities and more stable multi-step reasoning/execution. It demonstrates significant improvements in executing complex agent tasks while delivering more natural conversational experiences and superior front-end aesthetics.\",\"contextLength\":202752,\"pricing\":{\"prompt\":\"0.0000004\",\"completion\":\"0.0000015\"},\"architecture\":{\"inputModalities\":[\"text\"],\"outputModalities\":[\"text\"]}}', '2026-01-28 01:01:57', '2026-02-01 02:00:02', 0, 0, 0.000000);
INSERT INTO `model` (`id`, `name`, `description`, `provider`, `contextLength`, `inputPrice`, `outputPrice`, `recommended`, `isChina`, `supportsMultimodal`, `supportsImageGen`, `supportsToolCalling`, `tags`, `rawData`, `createTime`, `updateTime`, `isDelete`, `totalTokens`, `totalCost`) VALUES ('z-ai/glm-4.7-flash', 'Z.AI: GLM 4.7 Flash', 'As a 30B-class SOTA model, GLM-4.7-Flash offers a new option that balances performance and efficiency. It is further optimized for agentic coding use cases, strengthening coding capabilities, long-horizon task planning, and tool collaboration, and has achieved leading performance among open-source models of the same size on several current public benchmark leaderboards.', 'Zhipu AI', 200000, 0.070000, 0.400000, 0, 1, 0, 0, 1, '[\"快速\",\"中文\",\"文本生成\"]', '{\"id\":\"z-ai/glm-4.7-flash\",\"name\":\"Z.AI: GLM 4.7 Flash\",\"created\":1768833913,\"description\":\"As a 30B-class SOTA model, GLM-4.7-Flash offers a new option that balances performance and efficiency. It is further optimized for agentic coding use cases, strengthening coding capabilities, long-horizon task planning, and tool collaboration, and has achieved leading performance among open-source models of the same size on several current public benchmark leaderboards.\",\"contextLength\":200000,\"pricing\":{\"prompt\":\"0.00000007\",\"completion\":\"0.0000004\"},\"architecture\":{\"inputModalities\":[\"text\"],\"outputModalities\":[\"text\"]}}', '2026-01-28 01:01:57', '2026-02-01 02:00:02', 0, 0, 0.000000);
...
INSERT INTO `scene` (`id`, `userId`, `name`, `description`, `category`, `isPreset`, `isActive`, `createTime`, `updateTime`, `isDelete`) VALUES ('b6e32a8a-d96e-4f83-9eb2-e7a406931082', 370798160626356224, '自动化测试场景-编程能力', '用于自动化测试的编程能力评测场景', '编程', 1, 1, '2026-01-25 15:04:14', '2026-01-25 21:03:39', 0);
