...
import com.yupi.template.model.dto.test.DeleteTaskRequest;
...
public class BatchTestController {
    ...
    public BaseResponse<Boolean> deleteTask(
            @RequestBody DeleteTaskRequest deleteRequest,
            HttpServletRequest httpRequest
    ) {
        ThrowUtils.throwIf(deleteRequest == null || deleteRequest.getId() == null, ErrorCode.PARAMS_ERROR);
        User loginUser = userService.getLoginUser(httpRequest);
        
        boolean result = batchTestService.deleteTask(deleteRequest.getId(), loginUser.getId());
