 ...
 */
@Data
@Schema(description = "Battle匿名模型对比请求")
public class BattleRequest implements Serializable {

    /**
     * 模型列表 (2-8个)
     */
    @Schema(description = "模型列表(2-8个)", example = "[\"openai/gpt-4o\", \"anthropic/claude-3.5-sonnet\"]")
     ...
     */
    @Schema(description = "是否启用代码预览模式", example = "false")
    private Boolean codePreviewEnabled = false;
